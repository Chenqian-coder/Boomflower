<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AllOrderManage.aspx.cs" Inherits="admin_AllOrderManage" %>
    ...
    <table class="auto-style1">
        <tr>
            ...
            <td class="auto-style22" rowspan="9">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" CellPadding="3" DataKeyNames="perfumeName" Height="60px" OnRowDeleting="GridView1_RowDeleting" style="margin-left: 148px; margin-top: 0px;" Width="1000px" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" OnPageIndexChanging="GridView1_PageIndexChanging">
        <Columns>
        ...
        <tr>
            <td class="auto-style28" style="color: #FFFFFF; ">&nbsp;</td>
            <td class="auto-style24" style="color: #FFFFFF; ">
                <asp:HyperLink ID="HyperLink15" runat="server" Font-Underline="False" ForeColor="#66FFFF" NavigateUrl="~/admin/AllOrderManage.aspx">管理订单</asp:HyperLink>
            </td>
        </tr>
        <tr>
            <td class="auto-style28" style="color: #FFFFFF; ">&nbsp;</td>
