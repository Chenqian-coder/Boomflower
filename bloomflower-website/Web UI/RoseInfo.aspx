<%@ Page Title="" Language="C#" MasterPageFile="~/美食酒店详细页面母版.master" AutoEventWireup="true" CodeFile="RoseInfo.aspx.cs" Inherits="SightInfo" %>
...
&nbsp;</p>
    <p style="font-size: x-large; color: #FF6600">
        花&nbsp;&nbsp; 语： <asp:Label ID="lblIntroduction" runat="server" BorderStyle="Double" ForeColor="#CC0099"></asp:Label>
</p>
    <p style="font-size: x-large; color: #FF6600;">
        数 量&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <p style="font-size: x-large; color: #FF6600;">
        ...
        &nbsp;免运费</p>
    <p style="font-size: x-large; color: #FF6600;">收货人电话&nbsp;&nbsp; <asp:TextBox ID="txtPhone" runat="server" Width="162px"></asp:TextBox>
      
    </p>
    <p style="font-size: x-large; color: #FF6600;">
        市场价格：&nbsp; <asp:Label ID="lblPrice" runat="server" BorderStyle="Double" ForeColor="#CC0099"></asp:Label>
        <asp:Label ID="Label1" runat="server" Text="元"></asp:Label>
</p>
    <p style="font-size: x-large; color: #FF6600;">
        鲜花网价格： <asp:Label ID="lblTprice" runat="server" BorderStyle="Double" ForeColor="#CC0099"></asp:Label>
