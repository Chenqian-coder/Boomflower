...
public partial class xiangRiKui : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            food = XiangRiKuiBusiness.GetFoodInfoByNo(int.Parse(no));
            lblName.Text = food.Name;
            lblIntroduction.Text = food.Introduction;
            lblPrice.Text = food.Price.ToString();
            lblTprice.Text = food.Tprice.ToString();
            Image2.ImageUrl = "images\\" + food.Image;
        }
